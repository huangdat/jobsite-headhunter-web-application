...
/**
 * JobManageService
 * Responsible for managing the lifecycle of job postings (Write/Modify
 * operations).
 * Handles business logic for creating new jobs, updating information, toggling
 * recruitment status (open/close), and soft-deleting jobs.
 *
