...
public class SecurityConfig {
    ...
    String[] PUBLIC_GET_ENDPOINTS = {"/api/auth/**", "/api/business-profile/10-best", "/api/jobs/random-latest", "/api/business-profile", "/api/cv/myCv", "/api/forum/posts/**", "/api/forum/categories/search"};
